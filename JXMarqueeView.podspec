#
#  Be sure to run `pod spec lint JXMarqueeView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = "A powerful and easy to use marquee view. Happy to use!"

  s.homepage     = "https://github.com/pujiaxin33/JXMarqueeView"
  ...
  s.source_files  = "JXMarqueeView", "JXMarqueeView/JXMarqueeView/**/*.{swift}"
